    ...
    fs.lstat(self.filePath, function (err, stat) {
        ...
        if (stat && stat.isFile()) {
            fs.readFile(self.filePath, function (err, buf) {
                ...
                if (!cur.module_id) {
                    cur.module_id = escapeSlash(self.rootUrl + cur.filePath.substring(self.dirName.length))
                }
                ...
                for (var j = 0; j < fileList.length; j++) {
                    ...
                    self.moduleCache[_file] = {
                        filePath: _file,
                        module_id: escapeSlash(self.rootUrl + '' + _file.substring(self.dirName.length))
                    }
                }
